...
export function OpenerBoxWithOptions({options ,simplefilter ,setsimplefilter,children }:{children? :ReactNode, options?:string[],simplefilter : string ,setsimplefilter : Dispatch<SetStateAction<string>>}){
