...
export function BigInput({ name ,placeholder ,statesetter , state}:{state : string|any , statesetter : Dispatch<SetStateAction<string>>, name:string,placeholder:string }) {
