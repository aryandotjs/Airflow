...
export function OpenerButton({open ,setopen, children,simplefilter }:{simplefilter:string ,open:boolean ,setopen : Dispatch<SetStateAction<boolean>> ,children? : ReactNode}){
