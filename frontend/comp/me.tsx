...
export function Me2(){
     ...
     return <div onClick={()=> setopen(!open)} className="relative h-15 flex items-center w-full select-none ">
          ...
          {open? <div className="absolute top-[-34] w-full"> <OpenComp></OpenComp> </div> : ""}
