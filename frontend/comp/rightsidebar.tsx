...
import { Cross, Webhook } from './svg/allsvg'
...
export default function RightsideBar({sidebaropen ,setsidebaropen,setformDetail }:{sidebaropen:boolean , setsidebaropen : Dispatch<SetStateAction<boolean>>,setformDetail: Dispatch<SetStateAction<formdetailtype>>}) {
      ...
      ${sidebaropen ? "translate-x-0" : "translate-x-full"}`} >
         <div className='w-full p-3 flex justify-between items-center'>
            ...
            <div className='py-4'>
             ...
             {nodesuidata.map((a:nodesui,index)=>{
